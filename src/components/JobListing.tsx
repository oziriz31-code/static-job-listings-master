...
function JobListing({ job, addFilter }: JobListingProps) {
  ...
  return (
    <div className="relative flex flex-col md:flex-row justify-between items-center gap-4 bg-white border-l-4 border-primary-02 px-5 md:px-8 py-6 rounded-md shadow-lg">
      {/* Mobile Image */}
        ...
        <div className="mt-4 md:mt-0">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <div className="flex gap-2">
              {job.new && (
                <span className="inline-block rounded-full px-2.5 py-1 text-xs font-bold text-white bg-primary-02 uppercase">
                  New!
                </span>
              )}
              {job.featured && (
                <span className="inline-block rounded-full px-2.5 py-1 text-xs font-bold text-white bg-primary-03 uppercase">
                  Featured
                </span>
              )}
            </div>
